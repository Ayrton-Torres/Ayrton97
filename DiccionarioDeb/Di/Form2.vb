...
Public Class Form2
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim leer As New StreamReader("C:\Users\Ayrton\Downloads\Downloads.txt")
        ...
        Next item
        Dim im As New StreamReader("C:\Users\Ayrton\Downloads\ima.txt")
        Dim i As String
        While im.Peek <> -1
        ...
        Dim sig As New StreamReader("C:\Users\Ayrton\Downloads\sig.txt")
